...
public class StringCalculatorTest {
    ...
    @Test
    public void step8_test1_with_delimiter() {
        StringCalculator calculator = new StringCalculator();
        int result = calculator.add("//[*][,]\n1*2,3");
        assertEquals(6, result);
    }
    @Test
    public void step9_test1_with_delimiter() {
        StringCalculator calculator = new StringCalculator();
        int result = calculator.add("//[*][,]\n1****2,,3");
        assertEquals(6, result);
    }
    @Test
    public void step9_test2_with_delimiter() {
        StringCalculator calculator = new StringCalculator();
        int result = calculator.add("//[*][.]\n1****2..3");
        assertEquals(6, result);
    }
    @Test
    public void step9_test3_with_delimiter() {
        StringCalculator calculator = new StringCalculator();
        String input = "\"//[*][,]\\n1****2..3\"";
        try {
            int result = calculator.add(input);
